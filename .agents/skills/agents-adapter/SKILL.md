...
5. Update `VENDOR_EVIDENCE.md` for upstream facts, `COMPATIBILITY.md` and `compatibility.json` for support status, and CLI capabilities only when all claims are backed by evidence.
