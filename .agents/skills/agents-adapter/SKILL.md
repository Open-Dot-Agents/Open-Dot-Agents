...
5. Update `docs/VENDOR_EVIDENCE.md` for upstream facts, `docs/COMPATIBILITY.md` and `compatibility.json` for support status, and CLI capabilities only when all claims are backed by evidence.
